...
<div class="content">
    <div id="loginForm">
        <form enctype ="multipart/form-data" name="register" action="<?= $GLOBALS["config"]['site']['root']?>/registroUsuario" method="post">
            ...
            <button id="authButton" type="submit" name="button">OK</button>
        </form>
    </div>
</div>    
</body>
